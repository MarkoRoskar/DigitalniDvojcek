...
class MapFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        val input_type = arguments?.getString("input_type")
        ...
        okButton.setOnClickListener {
            ...
            if (input_type == "temp_sensor") {
                findNavController().navigate(R.id.tempSensorFragment, bundle)
            }
            else if (input_type == "event") {
        ...
        backButton.setOnClickListener {
            if (input_type == "temp_sensor") {
                findNavController().navigate(R.id.tempSensorFragment)   // navigate to temperature sensor fragment
            }
            else if (input_type == "event") {
